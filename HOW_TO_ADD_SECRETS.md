...
Нажмите на неё и добавьте каждый секрет по очереди:

### Секрет 1: SERVER_HOST

1. Нажмите **"New repository secret"**
2. В поле **Name** введите: `SERVER_HOST`
...
2. В поле **Name** введите: `SERVER_PASSWORD`
...
1. Снова нажмите **"New repository secret"**
2. В поле **Name** введите: `DEPLOY_PATH`
